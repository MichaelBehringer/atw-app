...
export default function NummernPicker({ open, title, value = [], onClose, onSubmit }) {
  ...
  return (
    ...
    >
      ...
      {/* auto-fill statt fester Spaltenzahl: am Handy passen rund sieben
          Nummern pro Reihe, am PC entsprechend mehr. */}
      <div
        style={{
          display: 'grid',
      ...
      >
        {Array.from({ length: MAX_NUMMER }, (_, i) => i + 1).map((nr) => {
